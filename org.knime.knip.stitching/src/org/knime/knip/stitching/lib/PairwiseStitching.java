...
public class PairwiseStitching {
    ...
    public static <T extends RealType<T>> RandomAccessibleInterval<T> performPairWiseStitching(
        ...
        // copy input since pc op changes these objects
        RandomAccessibleInterval<T> pcImg1 = imp1.copy();
        RandomAccessibleInterval<T> pcImg2 = imp2.copy();

        // compute the stitching
        long[] offset = ops.filter().phaseCorrelate(pcImg1, pcImg2,
